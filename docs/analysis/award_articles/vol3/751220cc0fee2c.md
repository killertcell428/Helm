# スマホ育児を学びと親子の会話につなげる「Coco-Ai」

**URL**: https://zenn.dev/yuma_s81128/articles/751220cc0fee2c
**取得日**: 2026-01-31 19:41:28

---

[![YUMA-S81128](https://lh3.googleusercontent.com/a/ACg8ocJM7lCu4Xdwyr00LO3P8jbyZVv7lGHwbQMRbEfrsxErXpk07Q=s96-c)YUMA-S81128](/yuma_s81128)
...
AI](/topics/ai)[![](https://storage.googleapis.com/zenn-user-upload/topics/fad3009b89.png)
...
AIエージェント](/topics/aiagent)[![](https://storage.googleapis.com/zenn-user-upload/topics/39434acf5a.png)

Agent Development Kit](/topics/adk)[![](https://static.zenn.studio/images/drawing/idea-icon.svg)
...
![](https://storage.googleapis.com/zenn-user-upload/29ab2410833a-20250921.png)
...
![](https://storage.googleapis.com/zenn-user-upload/5b6e94731e8f-20250921.png)

`ADK (Agent Development Kit)`, `Google GenAI SDK`（[参考サイト](#%E5%8F%82%E8%80%83%E3%82%B5%E3%82%A4%E3%83%88)参照）を活用してAIエージェントのワークフローを実装しています。ユーザーが話した質問を処理し、子ども向けの解説、イラスト、およびナレーション付きの音声応答を生成します。
...
2. **`ExplainerAgent`**: `Gemini 2.5 Flash`を利用し、書き起こされたテキストから以下の情報を構造化されたJSON形式で生成します。
   - 子ども向けの簡単な解説文
   - テキスト読み上げ用のSSML（[参考サイト](#%E5%8F%82%E8%80%83%E3%82%B5%E3%82%A4%E3%83%88)参照）形式のテキスト
   - 親子間の会話を促すための親向けのヒント
   - イラスト生成用の詳細なプロンプト
...
- Firebase App Check（[参考サイト](#%E5%8F%82%E8%80%83%E3%82%B5%E3%82%A4%E3%83%88)参照）  
...
- Vertex AI Agent Engineへの移行  
  Google Cloudに興味をもったきっかけであるCloud Runを絶対に使用したいという思いがあり、今回はAIエージェントはCloud Runにデプロイしました。その結果、Cloud Runの利便性を感じた一方で、ADKにおいて本番環境での使用が推奨される`VertexAISessionService`（[参考サイト](#%E5%8F%82%E8%80%83%E3%82%B5%E3%82%A4%E3%83%88)参照）の使用ができず、Firestoreでのセッション管理をGemini Code Assistの力を借りて独自実装する必要がありました。Vertex AI Agent Engine（[参考サイト](#%E5%8F%82%E8%80%83%E3%82%B5%E3%82%A4%E3%83%88)参照）を利用すればセッション管理までフルマネージドで任せられるようなので、本質的な価値創造に注力するためにも、デプロイ先の移行を検討します。
- ローカル開発環境の最適化  
...
[![YUMA-S81128](https://lh3.googleusercontent.com/a/ACg8ocJM7lCu4Xdwyr00LO3P8jbyZVv7lGHwbQMRbEfrsxErXpk07Q=s96-c)](/yuma_s81128)

[YUMA-S81128](/yuma_s81128)
...
2. [Coco-Aiが提供する体験](#coco-ai%E3%81%8C%E6%8F%90%E4%BE%9B%E3%81%99%E3%82%8B%E4%BD%93%E9%A8%93)
   1. [対象ユーザー像と課題](#%E5%AF%BE%E8%B1%A1%E3%83%A6%E3%83%BC%E3%82%B6%E3%83%BC%E5%83%8F%E3%81%A8%E8%AA%B2%E9%A1%8C)
   2. [課題に対するソリューション](#%E8%AA%B2%E9%A1%8C%E3%81%AB%E5%AF%BE%E3%81%99%E3%82%8B%E3%82%BD%E3%83%AA%E3%83%A5%E3%83%BC%E3%82%B7%E3%83%A7%E3%83%B3)
   3. [デモ動画](#%E3%83%87%E3%83%A2%E5%8B%95%E7%94%BB)
3. [アーキテクチャ・採用技術](#%E3%82%A2%E3%83%BC%E3%82%AD%E3%83%86%E3%82%AF%E3%83%81%E3%83%A3%E3%83%BB%E6%8E%A1%E7%94%A8%E6%8A%80%E8%A1%93)
   1. [システムアーキテクチャ](#%E3%82%B7%E3%82%B9%E3%83%86%E3%83%A0%E3%82%A2%E3%83%BC%E3%82%AD%E3%83%86%E3%82%AF%E3%83%81%E3%83%A3)
   2. [AIエージェントの処理フロー](#ai%E3%82%A8%E3%83%BC%E3%82%B8%E3%82%A7%E3%83%B3%E3%83%88%E3%81%AE%E5%87%A6%E7%90%86%E3%83%95%E3%83%AD%E3%83%BC)
   3. [実装したかったが見送った技術要素](#%E5%AE%9F%E8%A3%85%E3%81%97%E3%81%9F%E3%81%8B%E3%81%A3%E3%81%9F%E3%81%8C%E8%A6%8B%E9%80%81%E3%81%A3%E3%81%9F%E6%8A%80%E8%A1%93%E8%A6%81%E7%B4%A0)
4. [今後の展望](#%E4%BB%8A%E5%BE%8C%E3%81%AE%E5%B1%95%E6%9C%9B)
   1. [機能面](#%E6%A9%9F%E8%83%BD%E9%9D%A2)
   2. [技術面](#%E6%8A%80%E8%A1%93%E9%9D%A2)
5. [おわりに](#%E3%81%8A%E3%82%8F%E3%82%8A%E3%81%AB)
